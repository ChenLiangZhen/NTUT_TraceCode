...
#ifndef TRACECODE_SECURITYLEVEL_H
#define TRACECODE_SECURITYLEVEL_H
...
void execute_security_level() {
   ...
   f1(s1, s2); //s1, s2 are declared as array, no need to add & before passing it.
   printf("%s\n", s1);
   printf("%d\n", f2());
   f3(A, B, C, 2);
   printf("%d %d\n", C[0][0], C[1][1]);
